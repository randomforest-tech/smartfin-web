...
public class PoliceTestContainer extends TestContainer {

    public PoliceTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/police/app.properties",
    ...
    public static class Common extends PoliceTestContainer {

        public static final PoliceTestContainer.Common INSTANCE = new PoliceTestContainer.Common();
